          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href=""><img  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaFqZETyia_OGRMi21eSTZENOZRYGzGmHqrA&usqp=CAU"></a>
                      <a href="" style="text-align: center;"> <span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_masyarakat']); ?></span></a>
                  </div>
              </li>
